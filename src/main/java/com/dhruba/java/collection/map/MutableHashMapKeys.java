...
/**
 *In this map, we modified the key.
 *This resulted in a different hashcode value and java could not lookup the value
 *using the key because the hashcode has changed
 *
 */
